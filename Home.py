...
heart_disease_raw = pd.read_csv('heart.csv')
...
load_clf_NB = pickle.load(open('heart_disease_classifier_NB.pkl', 'rb'))
load_clf_knn = pickle.load(open('heart_disease_classifier_KNN.pkl', 'rb'))
load_clf_DT = pickle.load(open('heart_disease_classifier_DT.pkl', 'rb'))
...
st.write("<p style='font-size:20px; color: red'><b>REPORT</b></p>", unsafe_allow_html=True)
